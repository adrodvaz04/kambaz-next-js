  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My Favorite Recipe:
        <h4> Beef Stew with Rice and Beans </h4>
        <p>
          Perfect for a family dinner, this plate takes me back to my childhood
          in Puerto Rico.
        </p>
        <ol id="wd-your-favorite-recipe">
          <li> Boil potatoes and an onion until cooked. </li>
          <li> Sear your beef with the appropriate seasonings. </li>
          <li>
            {" "}
            Add tomato sauce, bay leaves, some water, and your vegetables into
            the beef pan, and let simmer for approx. 1hr.{" "}
          </li>
          <li> Enjoy! </li>
        </ol>
        ...
        <table border={1} width="100%">
          ...
          <tfoot>
            <tr>
              ...
              <td>
                {(85 + 100 + 98 + 90 + 92 + 87 + 60 + 93 + 83 + 0 + 90) / 10}
              </td>
            </tr>
          </tfoot>
        </table>
      ...
      to get dummy text
      <br />
      <a href="https://github.com/adrodvaz04" id="wd-github">
        My Github
      </a>
    </div>
  );
